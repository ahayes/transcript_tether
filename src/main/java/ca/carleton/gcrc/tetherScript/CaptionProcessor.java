...
public class CaptionProcessor {
     ...
     */
    public CaptionProcessor(YouTube youtu) throws NullPointerException {
    	if(youtu != null)
    		youtube = youtu;
    	else {
     ...
     * @throws IOException
     */
    protected void downloadCaption(String captionId) throws IOException {
      ...
      OutputStream outputFile = new FileOutputStream(ApiExample.OUTPUTFILE);
            ...
            public void progressChanged(MediaHttpUploader uploader) throws IOException {
                switch (uploader.getUploadState()) {
                    ...
                    case INITIATION_STARTED:
                        System.out.println("Caption --Initiation Started");
                        break;
                    ...
                    case MEDIA_IN_PROGRESS:
                        ...
                        System.out.print("\r Upload in progress +++ percentage: " + uploader.getProgress());
                        break;
                    // This value is set after the entire media file has
                    ...
                    //  not started yet.
                    case NOT_STARTED:
                        System.out.println("Caption --Upload Not Started!");
                        break;
                }
            }
        };
     ...
     * @throws IOException
     */
    protected List<Caption> listCaptions(String videoId) throws IOException {
      ...
      System.out.print("\r ================== Returned Caption Tracks ==================");
    ...
    /**
     * Returns one specific caption track. (captions.listCaptions.getItems()[i])
     *
     * @param videoId The videoId parameter instructs the API to return the
     * caption tracks for the video specified by the video id.
     * @throws IOException
